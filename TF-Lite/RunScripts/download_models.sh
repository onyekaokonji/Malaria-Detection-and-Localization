...
MODELS_URL="https://drive.google.com/file/d/1BVYSSGHuGiwRFDS5boZxlFp_1kXDzqDb/view?usp=sharing"
...
if [ -f ../MalariaClassification/Model/malaria_detection.tflite ]
then
...
cp ${DOWNLOADS_DIR}/models/* ../MalariaClassification/Model
